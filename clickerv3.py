...
labelUp = Button(window, text="Up", font=("Arial", 10), width = 25, anchor='center', command=lambda:countUp(), highlightthickness = 0, bd = 0)
labelUp.pack()
...
labelDown = Button(window, text="Down", font=("Arial", 10), width = 25, anchor='center', command=lambda:countDown(), highlightthickness = 0, bd = 0)
labelDown.pack()
